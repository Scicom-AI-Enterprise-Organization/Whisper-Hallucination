...
for three reasons that have nothing to do with word error rate.
...
Parakeet-TDT-0.6B-v3 are CC-BY-4.0 and are genuinely usable, but they cover 25 languages
against Whisper's 99.
...
language it detected first. A model trained on 25 European languages does not have this
problem to solve.
