...
\begin{table}[htbp]
\centering
\caption{The checkpoints, and the short labels used in every table and figure below.}
\label{tab:models}
\small
\begin{adjustbox}{max width=\linewidth}
\begin{tabular}{lll}
\toprule
\textbf{label} & \textbf{identifier} & \textbf{what it is} \\
\midrule
\texttt{large-v2} & \texttt{openai/whisper-large-v2} & base, 1.55 B \\
\texttt{large-v3} & \texttt{openai/whisper-large-v3} & base, 1.55 B \\
\texttt{turbo} & \texttt{openai/whisper-large-v3-turbo} & base, 4 decoder layers \\
\texttt{malaysian-v2} & \texttt{mesolitica/malaysian-whisper-large-v2} & Malay fine-tune of \texttt{large-v2} \\
\texttt{malaysian-turbo-v3} & \texttt{mesolitica/Malaysian-whisper-large-v3-turbo-v3} & Malay fine-tune of \texttt{turbo} \\
\bottomrule
\end{tabular}
\end{adjustbox}
\end{table}
...
\toprule
\textbf{arm} & \textbf{n} & \textbf{large-v2} & \textbf{large-v3} & \textbf{turbo} & \textbf{malaysian-v2} & \textbf{malaysian-turbo-v3} \\
\midrule
